  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Calculator",style: TextStyle(color: Colors.white, fontSize: 15*2),),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            calcButton('AC', Colors.orange, () => buttonPressed('AC')),
